...
<body>
    ...
    <section class="container">
        ...
        <div class="row-items">
            ...
            <div class="container-img-b">
                <img src="img/tourism.jpg" alt="hotels flights travelocity airline tickets vacation ">
            </div>
    ...
    <section class="container">
        <div class="row-items">
            <div class="container-img-b">
                <img src="img/maroc.jpg" alt="hotels flights travelocity airline tickets vacation ">
            </div>
